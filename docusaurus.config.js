...
const config = {
	...
	organizationName: "ark-tsudoi", // Usually your GitHub org/user name.
	...
	themeConfig:
		...
		({
				...
				links: [
					...
					},
					{
						...
						items: [
							...
							{
								label: "GitHub",
								href: "https://github.com/ark-tsudoi/homepage",
							},
						],
					},
				],
			...
			metadata: [
				{
					name: "keywords",
					content: "ARK,ARK非公式サーバ,ARKdiscord,にら鯖,ARKPC版サーバー",
				},
				{
					name: "description",
					content:
						"ARK非公式サーバー「にら鯖」では24時間365日全てのマップを提供しています。初心者から玄人の方までが楽しめるようなサーバーを提供しています。現在3000人程度の日本最大の非公式サーバーですぜひ参加してみてください‼︎",
				},
			],
		}),
};
